...
let determinismTests =
    testList
        ...
        [ test "same seed produces same score" {
              ...
              setSeed 42
              let h1, a1, _, _ = sim home away players staff

              setSeed 42
              let h2, a2, _, _ = sim home away players staff
          ...
          test "same seed produces same snapshots" {
              ...
              setSeed 42
              let replay1 = simFull home away players staff

              setSeed 42
              let replay2 = simFull home away players staff
